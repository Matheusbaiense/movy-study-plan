-- Movy Internal Hub - curated knowledge content import.
-- Generated from data/knowledge-sop-content.json after legacy cleanup.
...
values
  ...
  ($movy$links-recursos$movy$, $movy$Links & Recursos$movy$, $movy$Links & Recursos$movy$, $movy$Links & Recursos$movy$, $movy$#057570$movy$, null, true, $movy$Links uteis, recursos oficiais, intake dates.$movy$, $movy$Links uteis, recursos oficiais, intake dates.$movy$, $movy$Links uteis, recursos oficiais, intake dates.$movy$)
...
set is_active = false
where slug <> all (ARRAY[$movy$visao-geral$movy$, $movy$captacao-vendas$movy$, $movy$vistos$movy$, $movy$nomenclaturas$movy$, $movy$student-support$movy$, $movy$processos-ferramentas$movy$, $movy$politicas-internas$movy$, $movy$links-recursos$movy$]::text[]);

update public.contents
set status = 'archived'::public.content_status,
    updated_at = now()
where slug like 'knowledge-%'
  and slug <> all (ARRAY[$movy$knowledge-visao-geral-sobre-a-movy$movy$, $movy$knowledge-visao-geral-perfis-de-cliente$movy$, $movy$knowledge-visao-geral-pre-captacao-passiva$movy$, $movy$knowledge-captacao-vendas-captacao-primeiro-contato$movy$, $movy$knowledge-captacao-vendas-pos-captacao-vendas-consultoria-admissoes$movy$, $movy$knowledge-captacao-vendas-recap-educational-consultancy-timeline$movy$, $movy$knowledge-vistos-departamento-de-vistos$movy$, $movy$knowledge-vistos-formularios-de-visto$movy$, $movy$knowledge-student-support-visto-aprovado-e-agora$movy$, $movy$knowledge-student-support-reuniao-de-pre-embarque$movy$, $movy$knowledge-student-support-preparacao-final$movy$, $movy$knowledge-student-support-embarque-e-chegada-em-perth$movy$, $movy$knowledge-student-support-welcome-session-primeiros-passos$movy$, $movy$knowledge-student-support-processo-ongoing$movy$, $movy$knowledge-student-support-perguntas-frequentes$movy$, $movy$knowledge-processos-ferramentas-withdrawal-refund$movy$, $movy$knowledge-processos-ferramentas-cancelamento$movy$, $movy$knowledge-processos-ferramentas-change-of-course$movy$, $movy$knowledge-processos-ferramentas-attendance-progress-non-payment$movy$, $movy$knowledge-processos-ferramentas-jornada-onshore-renovacao-de-visto$movy$, $movy$knowledge-processos-ferramentas-monday-automacao-labels$movy$, $movy$knowledge-processos-ferramentas-board-de-welcome-student-support$movy$, $movy$knowledge-processos-ferramentas-monday-automacao-e-labels$movy$, $movy$knowledge-processos-ferramentas-oshc-planos-de-saude$movy$, $movy$knowledge-processos-ferramentas-commbank-como-abrir-uma-conta$movy$, $movy$knowledge-processos-ferramentas-usi-unique-student-identifier$movy$, $movy$knowledge-politicas-internas-dress-code-politica-de-vestimenta$movy$, $movy$knowledge-politicas-internas-leave-policy-licencas-e-ferias$movy$, $movy$knowledge-politicas-internas-anti-discrimination-harassment-bullying$movy$, $movy$knowledge-politicas-internas-whs-work-health-safety$movy$, $movy$knowledge-politicas-internas-it-policy-tecnologia-da-informacao$movy$, $movy$knowledge-politicas-internas-company-property-equipment$movy$, $movy$knowledge-links-recursos-links-imigracao$movy$, $movy$knowledge-links-recursos-intake-dates-datas-de-inicio-por-escola$movy$, $movy$knowledge-links-recursos-links-australia-estudante$movy$, $movy$knowledge-links-recursos-links-manter-se-informado$movy$, $movy$knowledge-links-recursos-materiais-movy-o-que-enviar-em-cada-fase$movy$, $movy$knowledge-nomenclaturas-pasta-documents$movy$, $movy$knowledge-nomenclaturas-pasta-enrolments-school-folder$movy$, $movy$knowledge-nomenclaturas-pasta-visa$movy$, $movy$knowledge-nomenclaturas-onde-salvar-guia-rapido-por-tipo-de-documento$movy$]::text[]);
...
select
  ...
  $movy$Formulários de Visto$movy$,
  $movy$Formulários de Visto$movy$,
  $movy$<div class="knowledge-sop"><table class="tbl"><thead><tr><th>Formulário</th><th>Função</th><th>Quem envia</th></tr></thead><tbody><tr><td><strong>T&C — Movy ENROL Agreement</strong></td><td>Contrato de prestação de serviços</td><td class="mut">Consultor — junto ao Next Step</td></tr><tr><td><strong>Movy ENROL Jotform (Offshore)</strong></td><td>Pré-matrícula e upload de docs — perfil offshore</td><td class="mut">Consultor envia link ao cliente</td></tr><tr><td><strong>Movy ENROL Jotform (Onshore)</strong></td><td>Pré-matrícula e upload de docs — perfil onshore</td><td class="mut">Consultor envia link ao cliente</td></tr><tr><td><strong>GS Student Visa</strong></td><td>Declaração de genuinidade — 5 perguntas</td><td class="mut">time de vistos elabora</td></tr><tr><td><strong>GS Partner (Dependent 18+)</strong></td><td>GS específica para cônjuge</td><td class="mut">time de vistos elabora</td></tr><tr><td><strong>GS Dependent Under 18</strong></td><td>GS para filhos menores de 18</td><td class="mut">time de vistos elabora</td></tr><tr><td><strong>Formulário 956A</strong></td><td>Autorização de representante de imigração</td><td class="mut">time de vistos</td></tr><tr><td><strong>Student Visa Form — Renewal</strong></td><td>Coleta de dados para renovação</td><td class="mut">time de vistos</td></tr><tr><td><strong>Subsequent Entrant</strong></td><td>Dependente de aluno já em Perth</td><td class="mut">time de vistos</td></tr><tr><td><strong>Medical History</strong></td><td>My Health Declarations — exames médicos</td><td class="mut">time de vistos (quando exigido)</td></tr><tr><td><strong>Withdrawal & Refund</strong></td><td>Cancelamento e reembolso</td><td class="mut">Financeiro / Admin</td></tr></tbody></table></div>$movy$,
...
select
  ...
  $movy$Reunião de Pré-Embarque$movy$,
  $movy$Reunião de Pré-Embarque$movy$,
  $movy$<div class="knowledge-sop"><div class="icards"><div class="icard"><div class="icard-lbl">Formato</div><div class="icard-val o">Online (offshore)</div></div><div class="icard"><div class="icard-lbl">Duração</div><div class="icard-val t">30–45 min</div></div><div class="icard"><div class="icard-lbl">Agendamento</div><div class="icard-val n">Link a adicionar</div></div><div class="icard"><div class="icard-lbl">Prazo</div><div class="icard-val r">4–8 sem. antes</div></div></div><div class="sh t">Antes da reunião</div><div class="cl"><div class="ci"><div class="cb"></div><div class="ct">Abrir PDF Manual de Sobrevivência para compartilhar tela</div></div><div class="ci"><div class="cb"></div><div class="ct">Abrir PPT Partes 1 e 2 (Pré-Embarque)</div></div><div class="ci"><div class="cb"></div><div class="ct">Ter o e-mail do aluno à mão para envio ao final</div></div><div class="ci"><div class="cb"></div><div class="ct">Confirmar que o aluno tem COE, Grant Letter e dados da acomodação</div></div></div><div class="sh t">Tópicos obrigatórios</div><ul class="bl"><li>Confirmação de dados: escola, data de embarque, acomodação, CommBank</li><li>Documentação — pasta digital e física (mala de mão)</li><li>Mala — franquias, itens proibidos, Dipirona proibida</li><li>Cartão de imigração — campo a campo com o PDF</li><li>Check-in online — como e quando</li><li>Primeiros passos em Perth — Welcome Session, OSHC, CommBank, TFN</li></ul><div class="sh t">Após a reunião — enviar ao aluno</div><div class="cl"><div class="ci"><div class="cb"></div><div class="ct">PDF — Manual de Sobrevivência do Estudante</div></div><div class="ci"><div class="cb"></div><div class="ct">PPT — Pré-Embarque (Partes 1 e 2)</div></div><div class="ci"><div class="cb"></div><div class="ct">Checklist Pré-Embarque (HTML interativo)</div></div><div class="ci"><div class="cb"></div><div class="ct">Link Welcome Session — Link a adicionar</div></div></div></div>$movy$,
  $movy$Online · 30–45 min · Link a adicionar· 4–8 sem. antes$movy$,
  d.id,
  'published'::public.content_status,
  ARRAY[$movy$knowledge$movy$, $movy$movy$movy$, $movy$student-support$movy$]::text[],
  $movy$process$movy$,
...
select
  ...
  $movy$Welcome Session + Primeiros Passos$movy$,
  $movy$Welcome Session + Primeiros Passos$movy$,
  $movy$<div class="knowledge-sop"><div class="icards"><div class="icard"><div class="icard-lbl">Formato</div><div class="icard-val o">Presencial/híbrido</div></div><div class="icard"><div class="icard-lbl">Local</div><div class="icard-val t">324 Murray St</div></div><div class="icard"><div class="icard-lbl">Agendamento</div><div class="icard-val n">Link a adicionar</div></div><div class="icard"><div class="icard-lbl">Prazo</div><div class="icard-val r">5–7 dias após chegada</div></div></div><div class="sh2">Prioridade 1 — Primeiras 48h</div><ul class="bl"><li>Ativar o OSHC online no site da seguradora</li><li>Ir à agência CommBank com passaporte + visto + COE</li></ul><div class="sh2">Prioridade 2 — Primeira semana</div><ul class="bl"><li>Solicitar TFN no ATO (ato.gov.au) — leva até 28 dias</li><li>Criar conta no USI (usi.gov.au) — obrigatório para VET e RSA</li><li>Confirmar onboarding da escola</li><li>Comprar chip pré-pago (Telstra / Optus / Vodafone)</li></ul><div class="sh2">Prioridade 3 — Primeiras semanas</div><ul class="bl"><li>Photo Card no DoT WA (ter TFN primeiro)</li><li>RSA se pretende trabalhar em bares/hotéis — AUD $65–100</li><li>RSG se pretende trabalhar em cassinos ou pubs com pokies</li><li>SmartRider Transperth — AUD $10 + $10 crédito, tarifa Go Anywhere $2,80</li></ul><div class="box warn"><strong>⚖️ DIREITOS TRABALHISTAS</strong>Visto estudante: máx. 48h/quinzena período letivo, ilimitado férias. Salário mínimo: AUD $24,95/h (jul 2025). Super: 12%. Pode denunciar ao Fair Work sem risco ao visto.</div></div>$movy$,
  $movy$Primeira semana em Perth · Link a adicionar$movy$,
  d.id,
  'published'::public.content_status,
  ARRAY[$movy$knowledge$movy$, $movy$movy$movy$, $movy$student-support$movy$]::text[],
  $movy$process$movy$,
...
select
  ...
  $movy$Monday — Automação + Labels$movy$,
  $movy$Monday — Automação + Labels$movy$,
  $movy$<div class="knowledge-sop"><div class="sh t">Fluxo entre boards</div><div class="steps"><div class="step"><div class="step-n">1.</div><div><div class="step-t">Lead entra no Monday — board de vendas/leads</div><div class="step-note">→ Inserido manualmente — integração Calendly desativada</div></div></div><div class="step"><div class="step-n">2.</div><div><div class="step-t">Status atualizado para PAGO</div></div></div><div class="step"><div class="step-n">3.</div><div><div class="step-t">Automação: aluno vai para o board de VISTO</div></div></div><div class="step"><div class="step-n">4.</div><div><div class="step-t">Visto aprovado → status APROVADO → aluno vai para board STUDENT SUPPORT</div></div></div><div class="step"><div class="step-n">5.</div><div><div class="step-t">Preencher campos adicionais: data de embarque, passagem, escola, data de início</div></div></div></div><div class="box info"><strong>📋 COLUNAS RECOMENDADAS — Student Support</strong>Nome · E-mail · WhatsApp · Escola · Data de início · Data de embarque · Nº passagem · Status · Último contato · Próximo check-in · Responsável · Observações</div><div class="box alert"><strong>🔴 PRIORIDADE — RECONECTAR CALENDLY</strong>Integração desativada há 6 meses. Todo lead é inserido manualmente. Reconectar é prioridade máxima.</div></div>$movy$,
...
select
  ...
  $movy$Dress Code — Política de Vestimenta$movy$,
  $movy$Dress Code — Política de Vestimenta$movy$,
  $movy$<div class="knowledge-sop"><ul class="bl"><li>Apresentação profissional com vestimenta adequada à função e excelente higiene pessoal</li><li>Calçados fechados são obrigatórios</li><li>Roupas devem estar limpas, em boas condições e passadas</li></ul><div class="sh2">Não é permitido:</div><ul class="bl"><li>Roupas com rasgos, buracos ou reparos visíveis</li><li>Roupas esportivas (agasalho, academia, ativewear)</li><li>Tops que expõem o abdômen</li><li>Havaianas, ugg boots ou chinelos</li><li>Tatuagens visíveis e piercings corporais (exceto brincos)</li><li>Roupas com estampas ofensivas ou inapropriadas</li></ul><p class="body-t">Crenças religiosas e culturais serão consideradas. A empresa pode alterar o dress code em ocasiões especiais.</p><div class="box warn"><strong>⚠️ DESCUMPRIMENTO</strong>O gestor pode solicitar que o funcionário vá para casa trocar de roupa. Reincidência pode resultar em demissão.</div></div>$movy$,
...
select
  ...
  $movy$Links uteis, recursos oficiais, intake dates.$movy$,
  d.id,
  'published'::public.content_status,
  ARRAY[$movy$knowledge$movy$, $movy$movy$movy$, $movy$links-recursos$movy$]::text[],
  $movy$reference$movy$,
...
select
  ...
  $movy$Onde salvar — guia rápido por tipo de documento$movy$,
  $movy$Onde salvar — guia rápido por tipo de documento$movy$,
  $movy$<div class="knowledge-sop"><div><div><div>📂 DOCUMENTS</div><ul class="bl"><li>Passaporte</li><li>Visto atual (Visa Grant)</li><li>OSHC / seguro</li><li>Comprovante VISA + OSHC</li><li>Certidão de casamento</li><li>Certificados de cursos</li><li>Históricos acadêmicos</li><li>Testes de inglês</li><li>Currículo (resume)</li><li>COEs anteriores</li><li>Comprovante tradução NAATI</li></ul></div><div><div>📂 ENROLMENTS / {school}</div><ul class="bl"><li>Formulários de matrícula</li><li>Offer Letter (todas as versões)</li><li>Offer Letter assinada</li><li>COE atual</li><li>COE cancelado</li><li>Comprovante de pagamento à escola</li><li>Change of Agency form</li></ul></div><div><div>📂 VISA</div><ul class="bl"><li>Form 956 (todas as versões)</li><li>GTE Letter (todas as versões)</li><li>Aplicação do visto (rascunhos + final)</li><li>IMMI Grant Notification</li><li>IMMI Refusal</li><li>Bridging Visa</li><li>Acknowledgement</li><li>Exames médicos (HAP ID)</li><li>Biometria</li><li>s56 Request</li></ul></div></div><div class="box warn"><strong>⚠️ ATENÇÃO</strong>O <strong>Visa Grant</strong> (visto atual) vai na pasta <strong>Documents</strong> — não na pasta Visa. A pasta Visa é para documentos do processo de aplicação, não para o visto em si.</div><div class="box tip"><strong>💡 LINK OFICIAL</strong>Consulte sempre o documento oficial de nomenclaturas no Google Drive: <span>Link a adicionar</span></div></div>$movy$,
