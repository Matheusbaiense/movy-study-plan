...
values
  ...
  ($movy$links-recursos$movy$, $movy$Links & Recursos$movy$, $movy$Links & Recursos$movy$, $movy$Links & Recursos$movy$, $movy$#3A1560$movy$, null, true, $movy$Links uteis, recursos oficiais, intake dates.$movy$, $movy$Links uteis, recursos oficiais, intake dates.$movy$, $movy$Links uteis, recursos oficiais, intake dates.$movy$)
