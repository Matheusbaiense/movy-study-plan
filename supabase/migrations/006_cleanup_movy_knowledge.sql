...
select
  ...
  $movy$Reunião de Pré-Embarque$movy$,
  $movy$Reunião de Pré-Embarque$movy$,
  $movy$<div class="legacy-sop"><div class="icards"><div class="icard"><div class="icard-lbl">Formato</div><div class="icard-val o">Online (offshore)</div></div><div class="icard"><div class="icard-lbl">Duração</div><div class="icard-val t">30–45 min</div></div><div class="icard"><div class="icard-lbl">Agendamento</div><div class="icard-val n">Link a adicionar</div></div><div class="icard"><div class="icard-lbl">Prazo</div><div class="icard-val r">4–8 sem. antes</div></div></div><div class="sh t">Antes da reunião</div><div class="cl"><div class="ci"><div class="cb"></div><div class="ct">Abrir PDF Manual de Sobrevivência para compartilhar tela</div></div><div class="ci"><div class="cb"></div><div class="ct">Abrir PPT Partes 1 e 2 (Pré-Embarque)</div></div><div class="ci"><div class="cb"></div><div class="ct">Ter o e-mail do aluno à mão para envio ao final</div></div><div class="ci"><div class="cb"></div><div class="ct">Confirmar que o aluno tem COE, Grant Letter e dados da acomodação</div></div></div><div class="sh t">Tópicos obrigatórios</div><ul class="bl"><li>Confirmação de dados: escola, data de embarque, acomodação, CommBank</li><li>Documentação — pasta digital e física (mala de mão)</li><li>Mala — franquias, itens proibidos, Dipirona proibida</li><li>Cartão de imigração — campo a campo com o PDF</li><li>Check-in online — como e quando</li><li>Primeiros passos em Perth — Welcome Session, OSHC, CommBank, TFN</li></ul><div class="sh t">Após a reunião — enviar ao aluno</div><div class="cl"><div class="ci"><div class="cb"></div><div class="ct">PDF — Manual de Sobrevivência do Estudante</div></div><div class="ci"><div class="cb"></div><div class="ct">PPT — Pré-Embarque (Partes 1 e 2)</div></div><div class="ci"><div class="cb"></div><div class="ct">Checklist Pré-Embarque (HTML interativo)</div></div><div class="ci"><div class="cb"></div><div class="ct">Link Welcome Session — Link a adicionar</div></div></div></div>$movy$,
