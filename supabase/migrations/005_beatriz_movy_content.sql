...
select
  ...
  $movy$Organograma$movy$,
  $movy$Organograma$movy$,
  $movy$<div class="legacy-sop"><div><img src="/imported/beatriz-sop-image-1.png" alt="Organograma Movy"></div></div>$movy$,
