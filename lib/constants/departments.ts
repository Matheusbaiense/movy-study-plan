export const DEPARTMENTS = [
  ...
  },
  {
    ...
    desc_pt: 'Links uteis, recursos oficiais, intake dates e contatos internos.',
    desc_en: 'Useful links, official resources, intake dates and internal contacts.',
    desc_es: 'Links utiles, recursos oficiales, intake dates y contactos internos.',
  },
  {
    slug: 'feedbacks',
    accent: '#A63A50',
    ...
    name_en: 'Feedback',
    name_es: 'Feedbacks',
    desc_pt: 'Dashboard e analise de feedbacks de estudantes.',
    desc_en: 'Student feedback dashboard and analysis.',
    desc_es: 'Dashboard y analisis de feedbacks de estudiantes.',
  },
  {
    slug: 'atendimentos',
    accent: '#7A4DB3',
    pillar: 'Atendimento',
    name_pt: 'Atendimentos',
    name_en: 'Support Cases',
    name_es: 'Atendimientos',
    desc_pt: 'Base de atendimentos, indicadores e motivos de contato.',
    desc_en: 'Support case base, indicators and contact reasons.',
    desc_es: 'Base de atendimientos, indicadores y motivos de contacto.',
  },
] as const
